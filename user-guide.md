...
> Software Version : OwlDB v.1.3.0
> Guide Version : v.1.3.0
...
{% endtab %}
{% tab title="환경별 준비 사항" %}
Provides preparation requirements for each environment to use OwlDB. 
...
🔎 [Go to Feature-Specific Usage Guide](function.md)
{% endtab %}
{% tab title="참고 자료" %}
