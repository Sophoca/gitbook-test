# Feature Usage Guide / My Page / Account Role Guide
...
When a Member requests account creation, the request is forwarded to Root, and the Member account is activated upon Root's approval.



## Member

Members can use the operations and management features provided by OwlDB (monitoring, backup/recovery, parameter management, etc.) only for DB services to which access has been granted by Root. Members can also directly request Root to create their own account.
