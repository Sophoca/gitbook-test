# Feature Usage Guide / My Page / Account Management
...
3. If needed, you can also grant DB service access permissions at this time.
...
Clicking a user ID in the account list displays the detailed information for that account. You can view and modify the detailed information of any account, including your own.
...
To make modifications, on the detail page, **[Edit]** Click the button.

---

## Account Creation Request Approval

When a user without an account submits an account creation request, the request appears in the **[Account Management]** menu `Account Requested` displayed with that status.
...
The ID of a deleted account cannot be reused. However, existing activity history and logs are retained.
