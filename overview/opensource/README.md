...
Some files or modules in this product are subject to the following licenses. 

{% tabs %}
{% tab title="Third-Party Notice and/or Licenses" %}
🔎 [Go to Third-Party Notice and/or Licenses](overview/opensource/third-party-notices-and-licenses.md)
{% endtab %}
{% tab title="Open Source Software Licenses" %}
🔎 [Go to Open Source Software Licenses](overview/opensource/open-source-software-licenses.md)
{% endtab %}
{% endtabs %}
